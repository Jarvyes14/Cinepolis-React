...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (activeTab === "alimentos" && alimentos.length === 0) {
      fetchAlimentos();
    }
  }, [activeTab, users.length, alimentos.length]);
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/3 bg-[#15274D] p-6 rounded-xl h-fit">
              ...
              <form onSubmit={handleAlimentoSubmit} className="flex flex-col gap-4">
                <input
                  type="text"
                  placeholder="Nombre de la Categoría (ej. Combos)"
                ...
                <div className="mt-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="font-semibold text-amber-300">Items</h3>
                    <button 
                      type="button" 

  ...
  return (
    <footer className="bg-[#070D1B] text-gray-400 py-8 px-4 sm:px-6 lg:px-8 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <ul className="space-y-2 text-sm text-center md:text-left">
            ...
            <li>
              <Link to="/cartelera" className="hover:text-amber-300 transition-colors">Cartelera</Link>
            </li>
            <li>
              <Link to="/alimentos" className="hover:text-amber-300 transition-colors">Alimentos</Link>
            </li>
            <li>
              <Link to="/otros" className="hover:text-amber-300 transition-colors">Extras</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="mt-8 pt-8 border-t border-gray-700 text-center text-xs">
        <p>&copy; {new Date().getFullYear()} Tu Cine. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}
